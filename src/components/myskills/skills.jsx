...
export const Myskills = () => {
  ...
  return (
    ...
    ">
      ...
      " >
        <div className="flex gap-6 items-center justify-center skiilBlockone">
          {" "}
        ...
        <div className="flex gap-6 items-center justify-center skiilBlockTwo">
         <div className="flex-1  flex flex-col items-center gap-3 text-center">
        ...
        <div className="flex gap-6 items-center justify-center skiilBlockThree">
           <div className="flex-1  flex flex-col items-center gap-3 text-center">
